...
export const ProfileBanner = ({ id, myprofile, name, image, profileData }) => {
            ...
            {myprofile ?
                <>
                    <div className='w-fit flex flex-row gap-8'>
                        <Statistic title={'Followers'} value={'120k'} />
                        <Statistic title={'Post'} value={'192'} />
                        <Statistic title={'Following'} value={'321'} />
                    </div>
                </>
                :
                <>
                    ...
                    <div className='w-fit flex flex-row items-center gap-2'>
                        ...
                        <div className='w-fit px-3 py-2 font-Golos text-xs font-normal whitespace-nowrap capitalize rounded-full text-black-900 border border-black-900'>1.2k</div>
                    </div>

                </>
            }
            <p className='max-w-[400px] font-Golos font-normal text-center text-xs leading-5 text-black-700'>Passionate blogger sharing insights on travel, tech, and lifestyle. Join me on a journey of discovery, tips, and inspiration. Let's explore together!</p>
        </div>
    )
}