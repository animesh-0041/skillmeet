            ...
            {blogContent ?
                <div className="w-full h-full flex flex-col md:flex-row gap-3 md:gap-2">
                    <div className="w-full flex flex-col gap-4 justify-between">
                        ...
                        <p className="w-full font-Golos text-[10px] text-normal text-black-300">Changes here will affect how your story appears in public places like blog's homepage and in subscribers’ inboxes — not the contents of the story itself.</p>
                    </div>
                    ...
                    <div className="w-full h-full flex flex-col justify-between gap-4 md:px-4">
                        ...
                        <div className="w-full flex flex-row justify-end gap-2">
                            ...
                            <button
                                ...
                                className={`w-fit min-w-24 px-2 flex flex-row gap-1 justify-center items-center whitespace-nowrap rounded-full font-Golos text-xs transform duration-200 capitalize text-white bg-green-200 hover:bg-green-300 active:bg-green-500 ${isWriteLoading && 'bg-green-300'}`}
                            >
