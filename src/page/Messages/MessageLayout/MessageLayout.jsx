...
export const MessageLayout = ({ children, userData, message, handleSend, handleTypeMessage }) => {
            ...
            <nav className="w-full flex flex-row justify-between py-2 border-b border-black-200">
                <div className="flex flex-row items-center gap-4">
                    <img
                        ...
                        src={userData?.photoURL || 'https://cdn-icons-png.flaticon.com/128/1999/1999625.png'}
                        onError={(e) => e.target.src = 'https://cdn-icons-png.flaticon.com/128/1999/1999625.png'}
                    />
                    <div className="flex flex-col gap-0">
                        <h1 className="font-Golos font-normal leading-5 text-xs capitalize text-black-700">{userData?.name || '---'}</h1>
                        <p className="font-Golos font-normal leading-3 text-[10px] text-green-300">Online</p>
                    </div>
                </div>
            </nav>
            <div id="hide_scrollbar" className="w-full h-[calc(100vh-180px)] box-border">
                {children}
            </div>
            {/* text area  */}
