...
import { requestNotificationPermission } from "../../components/Helper/Helper";
...
export const Login = () => {
  ...
  const { mutateAsync: LoginUser, isLoading: LoginLoading } = useMutation({
        ...
        <div className="w-full relative flex justify-center items-center gap-10">
          ...
          <div className="w-full max-w-[320px] flex flex-col gap-6">
            <div className="w-full flex flex-col gap-2">
              ...
              <p className="font-Golos font-normal text-xs leading-4 text-black-300">
            ...
            <Button
              ...
              className={`w-full px-4 py-2 rounded text-white bg-black-900 ${
                validButton()
                  ? "bg-opacity-80"
                  : "hover:bg-opacity-50 active:bg-opacity-90"
              }`}
            >
            ...
            <Paragraph center>
              ...
              <PageNavigation url={"/register"}>
                <Paragraph
                  color={"text-blue-900 border-b-[1px] border-blue-900"}
                >
                  Register Here
                </Paragraph>
              </PageNavigation>
