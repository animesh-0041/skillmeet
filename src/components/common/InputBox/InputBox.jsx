            ...
            return (
                <div className="w-full relative">
                    ...
                    <Input
                        ...
                        className={`w-full flex h-10 py-2 pl-12 pr-10 text-sm items-center font-Golos self-stretch rounded border-[0.5px] border-black-200 focus:outline-none focus:bg-black-25`}
                    />
                </div>
            )
        case "email":
            return (
                <div className="w-full relative">
                    ...
                    <Input
                        ...
                        onChange={onChange}
                        placeholder={placeholder}
                        className={`w-full flex h-10 py-2 pl-12 pr-10 text-sm items-center font-Golos self-stretch rounded border-[0.5px] border-solid ${errorMsg ? "bg-red-100 border-red-500" : "border-black-200 focus:outline-none focus:bg-black-25"}`}
                    />
                </div>
            )
        case "password":
        ...
        default:
            return (
                <Input
                    ...
                    onChange={onChange}
                    placeholder={placeholder}
                    className={`flex h-10 py-2 px-4 text-sm items-center font-Golos self-stretch rounded-lg border border-solid border-black-300 bg-black-0 focus:outline-none focus:bg-green-50 ${value && "bg-green-50"} ${errorMsg && "bg-red-50 border border-red-400"}`}
                />
            )
    }
}