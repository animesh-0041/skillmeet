    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div className='w-full relative px-3 flex flex-row justify-between items-center gap-2'>
                <button onClick={handleOpenReply} className='border border-black-500 px-2 py-1 z-10 rounded-full text-black-500 font-Golos text-xs font-normal leading-4 cursor-pointer'>Reply</button>
